...
규칙만 나열하고 끝내지 않고, 효과를 어떻게 알아볼지까지 확인해봅니다.
...
저장소는 이 문제를 이미 풀어놨습니다. 파일 목록을 보면 같은 내용이 두 번 들어 있습니다 — `CLAUDE.md`, 그리고 `skills/karpathy-guidelines/SKILL.md`. 중복처럼 보이지만 로딩 시점이 다릅니다.
